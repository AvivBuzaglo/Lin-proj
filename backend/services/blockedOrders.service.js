import fs from 'fs'
import { readJsonFile ,generateCalender } from './util.service.js'
import e from 'cors'
...
function queryHours(filterBy = { date: '' }) {
...
function removeHours(date, start) {
...
function postHours(blockedHoursToAdd) {
